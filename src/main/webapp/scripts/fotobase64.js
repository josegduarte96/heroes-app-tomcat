...
const form = document.getElementById('formAgregarHeroe') || document.getElementById('formEditarHeroe');
const fotoInput = document.getElementById('inputFoto');
const fotoHeroEdit = document.getElementById('superHeroEdit');
